...
function addCandidateStream(msg) {
  ...
  // video.setAttribute("style", "margin:5px;border:solid 2px red;border-radius:15px");
...
function createPeerConnection(remoteClient) {
  ...
  myPeerConnection.ontrack = function (event) {
    ...
    videotag.setAttribute("style", "margin:5px;border:solid 2px red;border-radius:15px");
